...
function doInsert(ibTag, ibClsTag, isSingle)
{
    ...
    } else if (is_nav && (myVersion > 4)) 
    {
        ...
        sel = obj_ta. value. substr(obj_ta.selectionStart, obj_ta.selectionEnd - obj_ta.selectionStart);
        ...
        // start....
//                if( obj_ta.selectionStart==undefined || obj_ta.selectionEnd==undefined){
//                 obj_ta. value += text;
//                }else{
//                 obj_ta. value = sel1 + text + sel2;
//                }
        if( obj_ta.selectionStart==undefined || obj_ta.selectionEnd==undefined){
                 obj_ta. value += text + ibTag + ( ibClsTag == "[/CODE]" ? "\n\n" : '' )+ibClsTag;
        }else{
              obj_ta. value = sel1 + text + sel2;
        }
        // end....

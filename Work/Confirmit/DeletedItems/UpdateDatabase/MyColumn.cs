...
{
    class MyColumn : MySmoObjectBase
    {
        ...
        public override bool IsEqual(MySmoObjectBase newValue)
        {
            ...
            {
                throw new Exception(string.Format("Column {0}.{1} has different types in source and production databases",
            ...
            //productionColumn.Collation == sourceColumn.Collation;
        }

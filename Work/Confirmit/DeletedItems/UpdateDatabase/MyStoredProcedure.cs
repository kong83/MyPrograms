...
{
    class MyStoredProcedure : MySmoObjectBase
    {
            ...
            Database databaseEngine)
        {
            ...
            if (newStoredProcedure.ImplementationType == ImplementationType.TransactSql)
            {
                ...
                newStoredProcedure.AssemblyName = "";
                newStoredProcedure.ClassName = "";
                newStoredProcedure.MethodName = "";
                ...
                else
                {
                    newStoredProcedure.TextBody = databaseEngine.GetTemplateTSQL(
                        ...
                        surveyId);
                    newStoredProcedure.TextHeader = databaseEngine.GetTemplateTSQL(

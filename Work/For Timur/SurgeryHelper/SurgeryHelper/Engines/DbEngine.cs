...
namespace SurgeryHelper.Engines
{
    ...
    public class DbEngine
    {
        ...
        /// </summary>
        /// <param name="cureInfo">Информация об лекарстве</param>
        ...
        /// </summary>
        /// <param name="cureOldName">Прежнее название лекарства, которое надо изменить</param>
        /// <param name="cureInfo">Информация о лекарстве</param>
        ...
        /// Удалить лекарство
        /// </summary>
        /// <param name="cureName">Название лекарства</param>
        ...
        /// <summary>
        /// Сдвинуть лекарство на один шаг вверх
        /// </summary>
        /// <param name="cureName">Название лекарства</param>
        ...
        /// <summary>
        /// Сдвинуть лекарство на один шаг вниз
        /// </summary>
        /// <param name="cureName">Название лекарства</param>
        ...
        #region Работа с дополнительными методами обследования
        /// <summary>
        /// Получить список лекарств
        /// </summary>
        ...
        /// </summary>
        /// <param name="surveyName">Название обследования</param>
        ...
        /// </summary>
        /// <param name="surveyOldName">Прежнее название обследования</param>
        /// <param name="surveyName">Новое название обследования</param>
        ...
        /// <summary>
        /// Сохранить список услуг и КСГ
        /// </summary>
        public void SaveServices()
        {
            Logger.WriteLog("Сохраняем дневные данные в " + _dayServicesPath);
            PackedData(DayServiceEngine.PrepareDataToPack(), _dayServicesPath);

            Logger.WriteLog("Сохраняем ночные данные в " + _nightServicesPath);
                ...
                foreach (string dataStr in datasStr)
                {
                    ...
                    switch (keyValue[0])
                    {
                        ...
                        case "LineOfCommEpicrisWritingDate":
                            ...
                            break;
                        case "DischargeEpicrisAnalysisDate":
                            patientInfo.DischargeEpicrisAnalysisDate = ConvertEngine.GetDateTimeFromString(keyValue[1]);
                            break;

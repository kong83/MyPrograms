...
{
    public static class CObjectsByMergeAdder
    {
        /// <summary>
        ...
        /// <param name="copyPrivateData">Копировать данных из личных папок</param>
        public static void CopyContent(MergeForm mergeForm, string fromFolder, string toFolder, bool copyPrivateData)
        {
